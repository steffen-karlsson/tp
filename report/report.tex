...
\section{Results}
By using this system, it is possible to generate the following results for three companies, one from the very top, one from the middle and one from the bottom, in this order in the table.
\begin{tabular}{ | l | c | c | c | c | r | }
  \hline
   & RMA & Price & Delivery & General & Original \\ \hline
  avc & 64.72 & 80.37 & 80.42 & 77.09 & 99 \\ \hline
  con & 52.01 & 69.51 & 69.12 & 65.26 & 68 \\ \hline
  son & 45.00 & 49.44 & 55.78 & 50.75 & 29 \\ \hline
\end{tabular}
